...
const modules = [
  { icon: '🎴', title: '游戏基础', badge: '核心规则', items: [
    ...
    { title: '无限注（No-Limit）', desc: '最流行的格式。任何时候都可以全押。翻前首个开池至少为 1BB；若面对下注或加注，最小再加注额至少要补足上一口的加注幅度。' },
  ...
  { icon: '🏆', title: '牌型大小排名', badge: '10种牌型', items: [
    { title: '1. 皇家同花顺', desc: 'A♠K♠Q♠J♠T♠ — 最大的同花顺，极其罕见。' },
    { title: '2. 同花顺', desc: '9♥8♥7♥6♥5♥ — 五张连续且同花色。' },
    { title: '3. 四条', desc: 'K♠K♥K♦K♣7♠ — 四张相同面值。' },
    { title: '4. 葫芦', desc: 'A♠A♥A♦K♠K♥ — 三条加一对。' },
    { title: '5. 同花', desc: 'A♣J♣8♣5♣2♣ — 五张相同花色。' },
    { title: '6. 顺子', desc: 'T♠9♥8♦7♣6♠ — 五张连续牌，不要求同花。' },
    { title: '7. 三条', desc: 'Q♠Q♥Q♦7♠3♣ — 三张相同面值。' },
    { title: '8. 两对', desc: 'J♠J♥5♦5♣K♠ — 两组不同的对子。' },
    { title: '9. 一对', desc: 'T♠T♥A♦8♣4♠ — 一组对子。' },
    { title: '10. 高牌', desc: 'A♠J♥8♦5♣2♠ — 没有成牌时比最大单张。' }
  ]},
  { icon: '📍', title: '位置详解', badge: '8个位置', items: [
    { title: 'UTG（枪口）', desc: '翻前第一个行动，范围最紧。本应用默认开池范围约 8%。' },
    { title: 'UTG+1', desc: '第二个行动，略宽于 UTG。本应用默认开池范围约 11%。' },
    { title: 'MP（中位）', desc: '中间位置，范围适中。本应用默认开池范围约 14%。' },
    { title: 'HJ（劫持位）', desc: '开始进入后位区域。本应用默认开池范围约 16%。' },
    { title: 'CO（关煞位）', desc: 'BTN 左边，好的偷盲位置。本应用默认开池范围约 23%。' },
    { title: 'BTN（按钮位）', desc: '最佳位置！翻后最后行动。本应用默认开池范围约 35%。' },
    { title: 'SB（小盲）', desc: '翻后第一个行动，位置不利。本应用默认开池范围约 29%。' },
  ...
  { icon: '💡', title: '新手黄金建议', badge: '10条建议', items: [
    ...
    { title: '3. 少做跛入', desc: '作为入门简化，翻前优先加注或弃牌，少用被动 limp。' },
    ...
    { title: '9. 资金管理', desc: '单场尽量只动用总 bankroll 的小比例，常见建议是 1%-5% 以内。' },
